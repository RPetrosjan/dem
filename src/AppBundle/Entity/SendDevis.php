...
class SendDevis
{
     ...
     * @var string
     *
     * @ORM\Column(name="prixht", type="string", length=16)
     */
    private $prixht;
     ...
     * @var User
     *
     * @ManyToOne(targetEntity="User", inversedBy="id_send_devis", cascade={"persist"})
     */
    private $user_id;
     ...
     * @return $this
     */
    public function setCp1(string $cp1)
    {
        $this->cp1 = $cp1;
     ...
     * @return this
     */
    public function setEtage1(string $etage1)
    {
        $this->etage1 = $etage1;
     ...
     * @return $this
     */
    public function setAscenseur1(string $ascenseur1)
    {
